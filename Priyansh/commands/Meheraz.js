...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@meheraz_islam_chisty")==0 || event.body.indexOf("𝐌𝐞𝐡𝐞𝐫𝐚𝐳 𝐢𝐬 𝐦𝐲 𝐛𝐨𝐬𝐬 𝐇𝐨𝐰 𝐜𝐚𝐧 𝐈 𝐡𝐞𝐥𝐩 𝐲𝐨𝐮 ☺")==0 || event.body.indexOf("@meheraz_islam_chisty")==0 || event.body.indexOf("Priyansh")==0) {
		var msg = {
				body: "𝕄𝕖𝕙𝕖𝕣𝕒𝕫 ✨💖🥀",
